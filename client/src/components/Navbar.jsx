    ...
    return(
        ...
        <div className="fixed left-0 top-0 h-screen w-64 bg-white shadow-xl flex flex-col p-6">
            ...
            <div className="flex flex-col justify-between mt-auto">
                <div className="text-lg font-normal text-gray-800 cursor-pointer hover:text-purple-600 hover:bg-gray-100 p-3 rounded-lg transition duration-200 mb-4">Settings</div>
