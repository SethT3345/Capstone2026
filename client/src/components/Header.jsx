...
export default function Header({ onSearch, searching, searchError }) {
  ...
  return (
    <header className="fixed top-0 right-0 left-64 bg-linear-to-r from-purple-50 via-white to-purple-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 z-10 px-8 py-6 shadow-sm">
