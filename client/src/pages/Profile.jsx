            ...
            <div className='flex'>
                ...
                <div className="right-side flex-1 min-h-screen bg-gray-100 ml-64">
                    ...
                    <main className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8 pt-28">
                        ...
                        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-lg shadow-lg p-8 mb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                {user ? (
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-900 font-medium">February 2026</p>
                                        </div>
                                    </div>
                                ) : (
                            ...
                            <div className="bg-white rounded-lg shadow-md p-6">
                                <div className="flex items-center mb-4">
                                    ...
                                    <h2 className="text-xl font-bold text-gray-900">Learning Stats</h2>
                                </div>
                                <div className="space-y-4">
                        ...
                        <div className="bg-white rounded-lg shadow-md p-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <button className="flex items-center justify-center gap-3 p-4 border-2 border-gray-200 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition duration-200">
                                ...
                                <button className="flex items-center justify-center gap-3 p-4 border-2 border-gray-200 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition duration-200">
                                    ...
                                    <span className="font-medium text-gray-700">My Learning</span>
                                </button>
                            </div>
                        </div>
                    </main>
