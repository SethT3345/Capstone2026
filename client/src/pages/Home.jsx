            ...
            <main className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8 pt-28">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-200">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="text-3xl font-bold text-gray-900">0h</span>
                        </div>
                        <h3 className="text-lg font-semibold text-gray-800 mb-2">Learning Time</h3>
                        <p className="text-gray-600 text-sm">Total hours invested</p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-md p-6 mb-8">
                    ...
                    <div className="text-center py-12">
                        ...
                        <h3 className="text-xl font-semibold text-gray-700 mb-2">No courses in progress</h3>
                        <p className="text-gray-500 mb-6">Start learning by enrolling in a course</p>
                        <button 
                            onClick={() => navigate('/courses')}
                            className="px-6 py-3 bg-purple-600 text-white rounded-lg font-semibold hover:bg-purple-700 transition duration-200 shadow-md"
                        >
                            Browse Courses
                        </button>
                    </div>
