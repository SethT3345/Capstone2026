            ...
            <main className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8 pt-28">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-4">Based on your interests and goals</p>
                        <button 
                            onClick={() => navigate('/courses')}
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                        <div className="flex items-center mb-4">
                            ...
                            <h3 className="text-xl  font-bold text-gray-900 dark:text-white">Your Achievements</h3>
                        </div>
                        <p className="text-gray-600 dark:text-gray-400 mb-4">Earn badges as you complete courses</p>
                        <button 
