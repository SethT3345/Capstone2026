              ...
              <div className="relative z-10 rounded-xl border border-white/10 bg-white/4 backdrop-blur-[20px] backdrop-saturate-150 py-8 px-6 shadow-[0_36px_100px_rgba(6,8,20,0.86)] transition-transform duration-220 ease-[cubic-bezier(.2,.9,.2,1)] hover:-translate-y-1.5 hover:scale-[1.01]">
                ...
                <form onSubmit={handleSubmit} className="space-y-6" noValidate onInvalid={(e) => e.preventDefault()}>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <a href="#" className="text-sm text-purple-600 dark:text-purple-300 hover:text-black dark:hover:text-white transition duration-200">
                            Forgot password?
                        </a>
                    </div>
                ...
                <button
                  ...
                  className="mt-4 w-full flex items-center justify-center gap-3 px-4 py-3 bg-white dark:bg-white/10 border-2 border-gray-300 dark:border-white/20 rounded-lg hover:bg-gray-50 dark:hover:bg-white/20 transition duration-200 shadow-sm"
                >
                  ...
                  <span className="font-medium text-gray-700 dark:text-white">Continue with Google</span>
                </button>
                ...
                <div className="mt-6 text-center">
                    <p className="text-sm text-black/70 dark:text-white/80">
                        ...
                        <Link to="/signup" className="text-blue-400 font-semibold hover:text-blue-600 dark:hover:text-white transition duration-200">
                            Sign up
                        </Link>
                    </p>
                </div>
